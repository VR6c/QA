...
const STATUS_COLORS = {
  ...
  done_production: { bg: 'bg-teal-100 text-teal-800 border-teal-300', dot: 'bg-teal-600' },
  success: { bg: 'bg-purple-100 text-purple-800 border-purple-300', dot: 'bg-purple-500' },
  ...
  progress: { bg: 'bg-blue-100 text-blue-800 border-blue-300', dot: 'bg-blue-500' },
